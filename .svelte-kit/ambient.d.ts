...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_ckeditor4: string;
	export const npm_package_dependencies_ckeditor5: string;
	...
	export const npm_package_dependencies_moment_jalaali: string;
	export const npm_package_dependencies_plantir_uikit: string;
	export const npm_package_dependencies_sass: string;
	export const npm_package_dependencies__faker_js_faker: string;
	export const npm_package_dependencies__types_leaflet: string;
	export const npm_package_dependencies__types_moment_jalaali: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_ckeditor4: string;
		npm_package_dependencies_ckeditor5: string;
		npm_package_dependencies_daisyui: string;
		npm_package_dependencies_leaflet: string;
		npm_package_dependencies_moment: string;
		npm_package_dependencies_moment_jalaali: string;
		npm_package_dependencies_plantir_uikit: string;
		npm_package_dependencies_sass: string;
		npm_package_dependencies__faker_js_faker: string;
		npm_package_dependencies__types_leaflet: string;
		npm_package_dependencies__types_moment_jalaali: string;
